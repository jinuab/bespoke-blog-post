    ...
    <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <form class="col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3">
                <input type="search" class="form-control form-control-dark" placeholder="Search Blog..." aria-label="Search">
            </form>
...
<?php /**PATH /Users/jinugeorge/bespoke-blog.dev/resources/views/layouts/partials/navbar.blade.php ENDPATH**/ ?>